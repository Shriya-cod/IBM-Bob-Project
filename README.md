...
```
Dermat/
├── dermatology_database.csv                  # Source dataset (UCI Dermatology)
...
- **Dataset source**: [UCI Machine Learning Repository — Dermatology Data Set](https://archive.ics.uci.edu/ml/datasets/Dermatology)
...
[https://archive.ics.uci.edu/ml/datasets/Dermatology](https://archive.ics.uci.edu/ml/datasets/Dermatology)

---

## 📄 License

This project is for educational and research purposes. The UCI Dermatology dataset is publicly available under the UCI Machine Learning Repository terms of use.
